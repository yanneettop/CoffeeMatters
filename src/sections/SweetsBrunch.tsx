        ...
        ScrollTrigger.create({
          ...
          onUpdate: (self) => {
            ...
            beansDecos?.forEach((bean, i) => {
              gsap.set(bean, { y: (i % 2 === 0 ? -15 : 20) + progress * (i % 2 === 0 ? 35 : -25), force3D: true });
            });
            if (bgFar)  gsap.set(bgFar,  { y: 10 - progress * 20, x: 5 - progress * 10, force3D: true });
            if (bgNear) gsap.set(bgNear, { y: -8 + progress * 16, force3D: true });
          }
        });
      }
    }, sectionRef);
